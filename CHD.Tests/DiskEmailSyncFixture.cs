...
{
    [TestClass]
    public sealed class DiskEmailSyncFixture : VersionedSyncFixture
    {
        public const string PathToSettingsFile = @"..\..\..\_PrivateData\Test\_email.xml";
        ...
        {
            IFileSystemSurgeonConnector surgeonConnector = ExtendedContext.GetEmailSugeonConnector(
                );
        ...
        #region cleanup email

        public void CleanupEmail(
            )
        {
