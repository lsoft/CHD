...
namespace MailRu.Cloud.WebApi.Connection
{
    internal class Connection : IConnection
    {
        ...
        public ServerPath RemoveFolder(
        ...
        public ServerPath CreateFolder(
            string name,
            ServerPath createIn
            )
        {
            ...
            )
        {
            ...
            request.Referer = string.Format("{0}/home{1}", ConstSettings.CloudDomain, path.GetLastElement());
            request.Headers.Add("Origin", ConstSettings.CloudDomain);
            request.Host = url.Host;
            request.ContentType = ConstSettings.DefaultRequestType;
            request.Accept = "*/*";
            ...
            using (Stream s = request.GetRequestStream())
            {
                ...
                using (var response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    var result = new ServerPath(folderPath);
